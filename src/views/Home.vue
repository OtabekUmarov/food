      ...
      <div class="dishes">
        <div class="row">
          <div class="col-4" v-for="dishe of dishes" :key="dishe.id">
            <div class="dish">
                <div class="img">
                  <!-- <img v-bind:src="`../assets/img/`+dishe.img" alt=""> -->
      ...
      <div class="orders">
        ...
        <div class="order">
          <div class="row" v-for="order of getOrders" :key="order.id" style="margin-bottom:24px;">
            ...
            <div class="col-2">
              <div class="order-sum">$4.49</div>
            </div>
            <div class="col-10">
              <input class="order-note" type="text" placeholder="Order Note...">
            </div>
            <div class="col-2">
              <button class="order-delete"><svg width="16" height="18" viewBox="0 0 16 18" fill="none" xmlns="http://www.w3.org/2000/svg">
